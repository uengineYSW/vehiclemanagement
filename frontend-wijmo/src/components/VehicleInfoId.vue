<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="vehicleinfos" searchParameterName=""  idField="brandModel" nameField="" path="vehicleinfos" label="VehicleInfoId" v-model="value" @selected="pick" :editMode="editMode" />
