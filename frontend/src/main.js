...
pluralCaseList.push( {plural: "users/userInfos", pascal: "UserUserInfo"} )

pluralCaseList.push( {plural: "drivers/driverInfos", pascal: "DriverDriverInfo"} )

pluralCaseList.push( {plural: "vehicles/vehicleInfos", pascal: "VehicleVehicleInfo"} )
