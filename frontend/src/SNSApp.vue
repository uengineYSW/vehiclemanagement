...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '사용자 정보', 
                description: '사용자 정보를 관리
- 이름 
- 주민등록번호
- 생년월일
- 주소', 
                key: 'userInfos', 
                route: '/users/userInfos',
                ImageUrl: '',
            },
            { 
                title: '운전자 정보', 
                description: '운전자 정보 관리
- 회사명
- 소속
- 연락처
- 권한
