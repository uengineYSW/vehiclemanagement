<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="userinfos" searchParameterName=""  idField="name" nameField="" path="userinfos" label="UserInfoId" v-model="value" @selected="pick" :editMode="editMode" />
